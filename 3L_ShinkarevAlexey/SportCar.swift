...
struct SportCar {
    ...
    {
        if isInvalid(modelName, year, windowsCount, tankVolume, trunkVolume, fuelConsumption, milage) { return nil }
        ...
        func isInvalid(_ modelName: String, _ year: Int, _ windowsCount: Int, _ tankVolume: Double, _ trunkVolume: Double, _ fuelConsumption: Double, _ milage: Double) -> Bool {
